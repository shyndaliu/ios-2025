...
class ViewController: UIViewController {
    ...
    func setupHero(){
        guard
            let heroData = UserDefaults.standard.data(forKey: "userHero"),
            let hero = try? PropertyListDecoder().decode(HeroModel.self, from: heroData)
        else{
            return
        }
    ...
    func saveHero(hero: HeroModel){
        ...
        UserDefaults.standard.set(data, forKey: "userHero")
    }
